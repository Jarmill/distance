function [p_out, cons, coeff_list] = constraint_psatz_csp(p, X, vars, d)
%CONSTRAINT_PSATZ Want to ensure that p >= 0 on region X
%   Use Putinar Positivestellensatz to ensure nonnegativity
%   Detect a correlative sparsity pattern, and use this pattern to break up
%   the psatz expression for nonnegativity
%
%Input:
...
%first find cliques of the correlative sparsity graph
